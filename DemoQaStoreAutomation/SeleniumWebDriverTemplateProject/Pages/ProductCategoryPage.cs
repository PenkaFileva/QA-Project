...
namespace SeleniumWebDriverTemplateProject.Pages
{
    ...
    public class ProductCategoryPage : Page
    {
        ...
        [FindsBy(How = How.CssSelector, Using = "span.icon:nth-child(3)")]
        public IWebElement CheckOutButton { get; set; }

        [FindsBy(How = How.ClassName, Using = "cart_icon")]
        public IWebElement CheckOutLink { get; set; }

        [FindsBy(How = How.CssSelector, Using = ".grid")]
        public IWebElement GridButton { get; set; }

        [FindsBy(How = How.CssSelector, Using = ".default")]
